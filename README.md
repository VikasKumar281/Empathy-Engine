...
Empathy Engine is a small experiment that combines **Natural Language Processing (NLP)** with **Text-to-Speech (TTS)** to generate more expressive audio.

Instead of reading text in a flat robotic tone, the system first **detects the emotion in a sentence** and then adjusts the **speed, pitch, and loudness** of the generated speech to match that emotion.
...
The project combines tools from **NLP and audio processing**.
